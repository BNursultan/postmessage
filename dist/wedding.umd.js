...
/*!************************!*\
  !*** ./src/helpers.js ***!
  \************************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e};function r(e){this.whitelist.includes(e.origin)?(this.origin=e.origin,this.events[e.data]&&this.events[e.data]()):console.error("Origin is not included in whitelist")}o.createConnection=function(e,o){if("undefined"==typeof window)return null;var s=document.createElement("iframe");return n(s,{name:"theFionce",src:e,style:{display:"none"}}),s.onload=function(){console.info("Frame loaded"),o(s)},document.body.append(s),s},o.createConnectionListener=function(){if("undefined"==typeof window)return;window.addEventListener?window.addEventListener("message",r.bind(this),!1):window.attachEvent("onmessage",r.bind(this))},o.validateConstructor=function(e,o,s){return function(e,o){if(e&&""===o)return console.error("Please provide correct url for connections"),!1;return!0}(e,o)&&function(e){if(0===e.length)return console.error("Please provide whitelist for connections"),!1;return!0}(s)};o.statuses={disconnected:"disconnected",connecting:"connecting",connected:"connected"}},"./src/index.js":
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e},r=d(s(/*! ./emitter */"./src/emitter.js")),t=d(s(/*! ./events */"./src/events.js")),u=s(/*! ./helpers */"./src/helpers.js");function d(e){return e&&e.__esModule?e:{"default":e}}var c=function(e){function o(s){var r=s.isConnecter,d=s.url,c=s.whitelist;!function(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}(this,o);var l=function(e,o){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!o||"object"!=typeof o&&"function"!=typeof o?e:o}(this,e.call(this));return n(l,{events:Object.create(null),isConnecter:r,url:d,whitelist:c,origin:"",frame:null,connectionInterval:null,status:u.statuses.disconnected}),u.createConnectionListener.call(l),t["default"].call(l),l}return function(e,o){if("function"!=typeof o&&null!==o)throw new TypeError("Super expression must either be null or a function, not "+typeof o);e.prototype=Object.create(o&&o.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),o&&(Object.setPrototypeOf?Object.setPrototypeOf(e,o):e.__proto__=o)}(o,e),o.prototype.connect=function(e){var o=this;this.isConnecter?(console.info("Initializing connection"),this.on("start",e),this.frame=(0,u.createConnection)(this.url,function(e){o.frame=e,o.frame?(o.connectionInterval=setInterval(function(){o.emit("connection:start")},1e3),o.status=u.statuses.connecting):console.error("Connector does not work in SSR")})):console.error("This is not a connector")},o}(r["default"]);o["default"]=c},0:
/*!***********************************!*\

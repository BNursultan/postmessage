...
/*!************************!*\
  !*** ./src/helpers.js ***!
  \************************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e};o.createConnection=function(e,o){if("undefined"==typeof window)return null;var s=document.createElement("iframe");return n(s,{name:"theFionce",src:e,style:{display:"none"}}),s.onload=function(){console.info("Frame loaded"),o(s)},document.body.append(s),s},o.createConnectionListener=function(){if("undefined"==typeof window)return;window.addEventListener?window.addEventListener("message",r,!1):window.attachEvent("onmessage",r)},o.validateConstructor=function(e,o,s){return function(e,o){if(e&&""===o)return console.error("Please provide correct url for connections"),!1;return!0}(e,o)&&function(e){if(0===e.length)return console.error("Please provide whitelist for connections"),!1;return!0}(s)};var r=function(e){undefined.whitelist.includes(e.origin)?(undefined.origin=e.origin,undefined.events[e.data]&&undefined.events[e.data]()):console.error("Origin is not included in whitelist")};o.statuses={disconnected:"disconnected",connecting:"connecting",connected:"connected"}},"./src/index.js":
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/

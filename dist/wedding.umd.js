...
/*!************************!*\
  !*** ./src/helpers.js ***!
  \************************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e};o.attachListener=t,o.createConnection=function u(){var e=this;var o=document.createElement("iframe");n(o,{name:"theFionce",src:this.url,style:{display:"none"}});document.body.append(o);var s=o.contentDocument||o.contentWindow.document;if("complete"===s.readyState)return console.info("Frame loaded"),this.frame=o,this.connectionInterval=setInterval(function(){e.emit("connection:start")},1e3),void(this.status=r.connecting);setTimeout(u.bind(this),500)},o.createConnectionListener=function(){window.addEventListener?window.addEventListener("message",t.bind(this),!1):window.attachEvent("onmessage",t.bind(this))},o.validateConstructor=function(e,o,s){if(e&&""===o)throw new Error("Please provide correct url for connections");if(0===s.length)throw new Error("Please provide whitelist for connections")},o.initEvents=function(){var e=this;this.on("connection:start",function(){e.emit("connection:finished"),e.emit("start")}),this.on("connection:finished",function(){clearInterval(e.connectionInterval),e.status=r.connected,console.info("Connection established")})};var r=o.statuses={disconnected:"disconnected",connecting:"connecting",connected:"connected"};function t(e){var o=e.origin,s=e.data;if(!this.whitelist.includes(o))throw new Error(o+" - is not included in whitelist");this.origin=o,this.events[s]&&this.events[s]()}},"./src/index.js":
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n,r=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e},t=s(/*! ./emitter */"./src/emitter.js"),u=(n=t)&&n.__esModule?n:{"default":n},d=s(/*! ./helpers */"./src/helpers.js");var c=function(e){function o(s){var n=s.isConnecter,t=s.url,u=s.whitelist;!function(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}(this,o);var c=function(e,o){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!o||"object"!=typeof o&&"function"!=typeof o?e:o}(this,e.call(this));return r(c,{events:Object.create(null),isConnecter:n,url:t,whitelist:u,origin:"",frame:null,connectionInterval:null,status:d.statuses.disconnected}),d.createConnectionListener.call(c),d.initEvents.call(c),c}return function(e,o){if("function"!=typeof o&&null!==o)throw new TypeError("Super expression must either be null or a function, not "+typeof o);e.prototype=Object.create(o&&o.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),o&&(Object.setPrototypeOf?Object.setPrototypeOf(e,o):e.__proto__=o)}(o,e),o.prototype.connect=function(){var e=arguments.length>0&&arguments[0]!==undefined?arguments[0]:null;if(!this.isConnecter)throw new Error("This is not a connector");if("function"!=typeof e)throw new Error("Please provide onStart callback");console.info("Initializing connection"),this.on("start",e),d.createConnection.call(this)},o}(u["default"]);o["default"]=c},0:
/*!***********************************!*\

...
/*!************************!*\
  !*** ./src/emitter.js ***!
  \************************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e};var r=function(){function e(){!function(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}(this,e)}return e.prototype.on=function(e,o){var s;if(this.events[e])throw new Error(e+" - event listner already exists");this.events=n(this.events,((s={})[e]=o,s))},e.prototype.emit=function(e){try{this.isConnecter?this.frame.contentWindow.postMessage(e,this.url):window.parent.postMessage(e,this.origin)}catch(o){throw new Error(o+" - Postmessage error on emit")}},e.prototype.off=function(e){var o;if(!this.events[e])throw new Error(e+" - event listner does not exists");this.events=n({},((o={})[e]=undefined,o))},e}();o["default"]=r},"./src/events.js":
/*!***********************!*\
  !*** ./src/events.js ***!
  \***********************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0,o["default"]=function(){var e=this;this.on("connection:start",function(){e.emit("connection:finished"),e.emit("start")}),this.on("connection:finished",function(){clearInterval(e.connectionInterval),e.status=n.statuses.connected,console.info("Connection established")})};var n=s(/*! ./helpers */"./src/helpers.js")},"./src/helpers.js":
/*!************************!*\
  !*** ./src/helpers.js ***!
  \************************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e};o.attachListener=t,o.createConnection=function u(){var e=this;var o=document.createElement("iframe");n(o,{name:"theFionce",src:this.url,style:{display:"none"}});document.body.append(o);var s=o.contentDocument||o.contentWindow.document;if("complete"===s.readyState)return console.info("Frame loaded"),this.frame=o,this.connectionInterval=setInterval(function(){e.emit("connection:start")},1e3),void(this.status=r.connecting);setTimeout(u.bind(this),500)},o.createConnectionListener=function(){window.addEventListener?window.addEventListener("message",t.bind(this),!1):window.attachEvent("onmessage",t.bind(this))},o.validateConstructor=function(e,o,s){if(e&&""===o)throw new Error("Please provide correct url for connections");if(0===s.length)throw new Error("Please provide whitelist for connections")};var r=o.statuses={disconnected:"disconnected",connecting:"connecting",connected:"connected"};function t(e){if(!this.whitelist.includes(e.origin))throw new Error(e.origin+" - is not included in whitelist");this.origin=e.origin,this.events[e.data]&&this.events[e.data]()}},"./src/index.js":
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e},r=d(s(/*! ./emitter */"./src/emitter.js")),t=d(s(/*! ./events */"./src/events.js")),u=s(/*! ./helpers */"./src/helpers.js");function d(e){return e&&e.__esModule?e:{"default":e}}var c=function(e){function o(s){var r=s.isConnecter,d=s.url,c=s.whitelist;!function(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}(this,o);var l=function(e,o){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!o||"object"!=typeof o&&"function"!=typeof o?e:o}(this,e.call(this));return n(l,{events:Object.create(null),isConnecter:r,url:d,whitelist:c,origin:"",frame:null,connectionInterval:null,status:u.statuses.disconnected}),u.createConnectionListener.call(l),t["default"].call(l),l}return function(e,o){if("function"!=typeof o&&null!==o)throw new TypeError("Super expression must either be null or a function, not "+typeof o);e.prototype=Object.create(o&&o.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),o&&(Object.setPrototypeOf?Object.setPrototypeOf(e,o):e.__proto__=o)}(o,e),o.prototype.connect=function(){var e=arguments.length>0&&arguments[0]!==undefined?arguments[0]:null;if(!this.isConnecter)throw new Error("This is not a connector");if("function"!=typeof e)throw new Error("Please provide onStart callback");console.info("Initializing connection"),this.on("start",e),u.createConnection.call(this)},o}(r["default"]);o["default"]=c},0:
/*!***********************************!*\

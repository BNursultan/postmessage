...
/*!************************!*\
  !*** ./src/emitter.js ***!
  \************************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e};var r=function(){function e(){!function(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}(this,e)}return e.prototype.on=function(e,o){var s;if(this.events[e])throw new Error(e+" - event listner already exists");this.events=n(this.events,((s={})[e]=o,s))},e.prototype.emit=function(e){try{this.isConnecter?this.frame.contentWindow.postMessage(e,this.url):window.parent.postMessage(e,this.origin)}catch(o){throw new Error(o+" - Postmessage error on emit")}},e.prototype.off=function(e){var o;if(!this.events[e])throw new Error(e+" - event listner does not exists");this.events=n({},((o={})[e]=undefined,o))},e}();o["default"]=r},"./src/helpers.js":
/*!************************!*\
  !*** ./src/helpers.js ***!
  \************************/
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n,r=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e},t=s(/*! ./emitter */"./src/emitter.js"),u=(n=t)&&n.__esModule?n:{"default":n},d=s(/*! ./helpers */"./src/helpers.js");var c=function(e){function o(s){var n=s.isConnecter,t=s.url,u=s.whitelist;!function(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}(this,o);var c=function(e,o){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!o||"object"!=typeof o&&"function"!=typeof o?e:o}(this,e.call(this));return r(c,{events:Object.create(null),isConnecter:n,url:t,whitelist:u,origin:"",frame:null,connectionInterval:null,status:d.statuses.disconnected}),d.createConnectionListener.call(c),d.initEvents.call(c),c}return function(e,o){if("function"!=typeof o&&null!==o)throw new TypeError("Super expression must either be null or a function, not "+typeof o);e.prototype=Object.create(o&&o.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),o&&(Object.setPrototypeOf?Object.setPrototypeOf(e,o):e.__proto__=o)}(o,e),o.prototype.connect=function(){var e=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};if(!this.isConnecter)throw new Error("This is not a connector");console.info("Initializing connection"),this.on("start",e),d.createConnection.call(this)},o}(u["default"]);o["default"]=c},0:
/*!***********************************!*\

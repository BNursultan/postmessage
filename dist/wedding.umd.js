...
/*!*************************************************!*\
  ...
  \*************************************************/
/*! no static exports found */function(e,o,s){var n=s(/*! ./_global */"./node_modules/core-js/modules/_global.js"),r=s(/*! ./_core */"./node_modules/core-js/modules/_core.js"),t=s(/*! ./_hide */"./node_modules/core-js/modules/_hide.js"),u=s(/*! ./_redefine */"./node_modules/core-js/modules/_redefine.js"),d=s(/*! ./_ctx */"./node_modules/core-js/modules/_ctx.js"),c=function(e,o,s){var l,i,j,m,_=e&c.F,a=e&c.G,f=e&c.S,p=e&c.P,b=e&c.B,y=a?n:f?n[o]||(n[o]={}):(n[o]||{}).prototype,h=a?r:r[o]||(r[o]={}),v=h.prototype||(h.prototype={});for(l in a&&(s=o),s)j=((i=!_&&y&&y[l]!==undefined)?y:s)[l],m=b&&i?d(j,n):p&&"function"==typeof j?d(Function.call,j):j,y&&u(y,l,j,e&c.U),h[l]!=j&&t(h,l,m),p&&v[l]!=j&&(v[l]=j)};n.core=r,c.F=1,c.G=2,c.S=4,c.P=8,c.B=16,c.W=32,c.U=64,c.R=128,e.exports=c},"./node_modules/core-js/modules/_fails.js":
/*!************************************************!*\
...
/*!*************************************************************!*\
  ...
  \*************************************************************/
/*! no static exports found */function(e,o,s){"use strict";var n=s(/*! ./_export */"./node_modules/core-js/modules/_export.js"),r=s(/*! ./_to-integer */"./node_modules/core-js/modules/_to-integer.js"),t=s(/*! ./_a-number-value */"./node_modules/core-js/modules/_a-number-value.js"),u=s(/*! ./_string-repeat */"./node_modules/core-js/modules/_string-repeat.js"),d=1..toFixed,c=Math.floor,l=[0,0,0,0,0,0],i="Number.toFixed: incorrect invocation!",j=function(e,o){for(var s=-1,n=o;++s<6;)n+=e*l[s],l[s]=n%1e7,n=c(n/1e7)},m=function(e){for(var o=6,s=0;--o>=0;)s+=l[o],l[o]=c(s/e),s=s%e*1e7},_=function(){for(var e=6,o="";--e>=0;)if(""!==o||0===e||0!==l[e]){var s=String(l[e]);o=""===o?s:o+u.call("0",7-s.length)+s}return o},a=function(e,o,s){return 0===o?s:o%2==1?a(e,o-1,s*e):a(e*e,o/2,s)};n(n.P+n.F*(!!d&&("0.000"!==8e-5.toFixed(3)||"1"!==.9.toFixed(0)||"1.25"!==1.255.toFixed(2)||"1000000000000000128"!==(0xde0b6b3a7640080).toFixed(0))||!s(/*! ./_fails */"./node_modules/core-js/modules/_fails.js")(function(){d.call({})})),"Number",{toFixed:function(e){var o,s,n,d,c=t(this,i),l=r(e),f="",p="0";if(l<0||l>20)throw RangeError(i);if(c!=c)return"NaN";if(c<=-1e21||c>=1e21)return String(c);if(c<0&&(f="-",c=-c),c>1e-21)if(s=(o=function(e){for(var o=0,s=e;s>=4096;)o+=12,s/=4096;for(;s>=2;)o+=1,s/=2;return o}(c*a(2,69,1))-69)<0?c*a(2,-o,1):c/a(2,o,1),s*=4503599627370496,(o=52-o)>0){for(j(0,s),n=l;n>=7;)j(1e7,0),n-=7;for(j(a(10,n,1),0),n=o-1;n>=23;)m(1<<23),n-=23;m(1<<n),j(1,1),m(2),p=_()}else j(0,s),j(1<<-o,0),p=_()+u.call("0",l);return p=l>0?f+((d=p.length)<=l?"0."+u.call("0",l-d)+p:p.slice(0,d-l)+"."+p.slice(d-l)):f+p}})},"./node_modules/core-js/modules/es6.number.to-precision.js":
/*!*****************************************************************!*\
...
/*!************************!*\
  !*** ./src/emitter.js ***!
  \************************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e};var r=function(){function e(){!function(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}(this,e),this.events=Object.create(null)}return e.prototype.on=function(e,o){var s;this.events[e]?console.error("This event listner already exists"):this.events=n(this.events,((s={})[e]=o,s))},e.prototype.emit=function(e){this.isConnecter?this.frame.contentWindow.postMessage(e,this.url):window.parent.postMessage(e,this.url)},e.prototype.off=function(e){var o;this.events[e]?this.events=n({},((o={})[e]=undefined,o)):console.error("This event listner doesnt exists")},e}();o["default"]=r},"./src/events.js":
/*!***********************!*\
  !*** ./src/events.js ***!
  \***********************/
...
/*!************************!*\
  !*** ./src/helpers.js ***!
  \************************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e};o.createConnection=function(e){var o=document.createElement("iframe");return n(o,{name:"theFionce",src:e,style:{display:"none"}}),document.body.append(o),o},o.createConnectionListener=function(e,o){window.addEventListener?window.addEventListener("message",function(s){e.includes(s.origin)?o.events[s.data]():console.error("Origin is not included in whitelist")},!1):window.attachEvent("onmessage",function(s){e.includes(s.origin)?o.events[s.data]():console.error("Origin is not included in whitelist")})},o.validateConstructor=function(e,o,s){return function(e,o){if(e&&""===o)return console.error("Please provide correct url for connections"),!1;return!0}(e,o)&&function(e){if(0===e.length)return console.error("Please provide whitelist for connections"),!1;return!0}(s)};o.statuses={disconnected:"disconnected",connecting:"connecting",connected:"connected"}},"./src/index.js":
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e},r=d(s(/*! ./emitter */"./src/emitter.js")),t=d(s(/*! ./events */"./src/events.js")),u=s(/*! ./helpers */"./src/helpers.js");function d(e){return e&&e.__esModule?e:{"default":e}}var c=function(e){function o(s){var r=s.isConnecter,d=s.url,c=s.whitelist;!function(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}(this,o);var l=function(e,o){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!o||"object"!=typeof o&&"function"!=typeof o?e:o}(this,e.call(this));return n(l,{isConnecter:r,url:d,whitelist:c,frame:null,connectionInterval:null,status:u.statuses.disconnected}),(0,u.createConnectionListener)(l.whitelist),t["default"].call(l),l}return function(e,o){if("function"!=typeof o&&null!==o)throw new TypeError("Super expression must either be null or a function, not "+typeof o);e.prototype=Object.create(o&&o.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),o&&(Object.setPrototypeOf?Object.setPrototypeOf(e,o):e.__proto__=o)}(o,e),o.prototype.connect=function(){var e=this;this.isConnecter?(console.info("Initializing connection"),this.frame=(0,u.createConnection)(this.url),this.connectionInterval=setInterval(function(){e.emit("connection:start")},1e3),this.status=u.statuses.connecting):console.error("This is not a connector")},o}(r["default"]);o["default"]=c},0:
/*!***********************************!*\

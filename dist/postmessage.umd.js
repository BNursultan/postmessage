...
/*!*************************************************!*\
  ...
  \*************************************************/
/*! no static exports found */function(e,o,s){var n=s(/*! ./_global */"./node_modules/core-js/modules/_global.js"),r=s(/*! ./_core */"./node_modules/core-js/modules/_core.js"),t=s(/*! ./_hide */"./node_modules/core-js/modules/_hide.js"),u=s(/*! ./_redefine */"./node_modules/core-js/modules/_redefine.js"),d=s(/*! ./_ctx */"./node_modules/core-js/modules/_ctx.js"),c=function(e,o,s){var l,i,j,m,a=e&c.F,_=e&c.G,f=e&c.S,p=e&c.P,b=e&c.B,y=_?n:f?n[o]||(n[o]={}):(n[o]||{}).prototype,h=_?r:r[o]||(r[o]={}),v=h.prototype||(h.prototype={});for(l in _&&(s=o),s)j=((i=!a&&y&&y[l]!==undefined)?y:s)[l],m=b&&i?d(j,n):p&&"function"==typeof j?d(Function.call,j):j,y&&u(y,l,j,e&c.U),h[l]!=j&&t(h,l,m),p&&v[l]!=j&&(v[l]=j)};n.core=r,c.F=1,c.G=2,c.S=4,c.P=8,c.B=16,c.W=32,c.U=64,c.R=128,e.exports=c},"./node_modules/core-js/modules/_fails.js":
/*!************************************************!*\
...
/*!************************!*\
  !*** ./src/emitter.js ***!
  \************************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e},r=s(/*! ./helpers */"./src/helpers.js");var t=function(){function e(){!function(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}(this,e)}return e.prototype.on=function(e,o){var s;if(this.events[e])throw new Error(e+" - event listner already exists");this.events=n(this.events,((s={})[e]=o,s))},e.prototype.emit=function(e){try{this.isConnecter?window.frames[r.FRAME_NAME].postMessage(e,this.url):window.parent.postMessage(e,this.origin),this.log&&console.info(e+" - event is emitted")}catch(o){throw new Error(o+" - Postmessage error on emit")}},e.prototype.off=function(e){var o;if(!this.events[e])throw new Error(e+" - event listner does not exists");this.events=n({},((o={})[e]=undefined,o))},e}();o["default"]=t},"./src/helpers.js":
/*!************************!*\
  !*** ./src/helpers.js ***!
  \************************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0,o.attachListener=t,o.createConnection=function(){var e=this,o=document.createElement("iframe");o.style.display="none",o.name=n,o.src=this.url,document.body.append(o),this.status=r.connecting,this.frame=o,o.onload=function(){console.info("Frame loaded"),e.connectionInterval=setInterval(function(){e.emit("connection:start")},1e3)}},o.createConnectionListener=function(){window.addEventListener?window.addEventListener("message",t.bind(this),!1):window.attachEvent("onmessage",t.bind(this))},o.validateConstructor=function(e,o,s){if(e&&""===o)throw new Error("Please provide correct url for connections");if(0===s.length)throw new Error("Please provide whitelist for connections");if("boolean"!=typeof e)throw new Error("isConnecter - argument should be a boolean");if("string"!=typeof o)throw new Error("url - argument should be a string");if(!Array.isArray(s))throw new Error("whitelist - argument should be an array of url strings")},o.initEvents=function(){var e=this;this.on("connection:start",function(){e.emit("connection:finished"),e.emit("start")}),this.on("connection:finished",function(){clearInterval(e.connectionInterval),e.status=r.connected,console.info("Connection established")})};var n=o.FRAME_NAME="theFionce",r=o.statuses={disconnected:"disconnected",connecting:"connecting",connected:"connected"};function t(e){var o=e.origin,s=e.data;if(!this.whitelist.includes(o))throw new Error(o+" - is not included in whitelist");this.origin=o,this.events[s]&&this.events[s]()}},"./src/index.js":
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! no static exports found */function(e,o,s){"use strict";o.__esModule=!0;var n,r=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var s=arguments[o];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(e[n]=s[n])}return e},t=s(/*! ./emitter */"./src/emitter.js"),u=(n=t)&&n.__esModule?n:{"default":n},d=s(/*! ./helpers */"./src/helpers.js");var c=function(e){function o(s){var n=s.isConnecter,t=s.url,u=s.whitelist,c=s.log;!function(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}(this,o);var l=function(e,o){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!o||"object"!=typeof o&&"function"!=typeof o?e:o}(this,e.call(this));return r(l,{isConnecter:n,url:t,whitelist:u,log:c,events:Object.create(null),origin:"",frame:null,connectionInterval:null,status:d.statuses.disconnected}),d.createConnectionListener.call(l),d.initEvents.call(l),l}return function(e,o){if("function"!=typeof o&&null!==o)throw new TypeError("Super expression must either be null or a function, not "+typeof o);e.prototype=Object.create(o&&o.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),o&&(Object.setPrototypeOf?Object.setPrototypeOf(e,o):e.__proto__=o)}(o,e),o.prototype.connect=function(){var e=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};if(!this.isConnecter)throw new Error("This is not a connector");console.info("Initializing connection"),this.on("start",e),d.createConnection.call(this)},o}(u["default"]);o["default"]=c},0:
/*!***********************************!*\
